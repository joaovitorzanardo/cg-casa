...
bool CShaderManager::HasGLSLSupport(void)
{
	...
	if ((GLEW_VERSION_4_0) || (GLEW_VERSION_4_1) || (GLEW_VERSION_4_2) || (GLEW_VERSION_4_3) || (GLEW_VERSION_4_4) || (GLEW_VERSION_4_5))
	{
...
void CShaderManager::InitShaderManager(int shaderID, const char *vsFile, const char *fsFile)
{
	...
	this->iShadersCont++;
	this->aShaders[shaderID] = shaderData;
}
